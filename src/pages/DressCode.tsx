...
import { Shirt, Sparkles, Ban, Gem } from "lucide-react";
...
const DressCode = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-gradient-to-br from-blue-900/30 via-emerald-900/20 to-amber-900/30 backdrop-blur-[2px]"
        aria-hidden="true"
      />
