...
const translations: Record<Language, Record<string, string>> = {
  ...
  de: {
    ...
    "dresscode.rule.description": "Die einzige Regel ist, dass man KEINEN formellen Anzug (klassische Jacke und Krawatte) tragen darf. Wir wollen eine entspannte und festliche Atmosphäre — keine konventionelle Hochzeit!",
